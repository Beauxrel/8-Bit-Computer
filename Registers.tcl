...
#
# Registers.tcl: Tcl script for re-creating project 'Registers'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/sources/one_shot.v"]"\
 "[file normalize "$origin_dir/sources/sap_register.v"]"\
